# The Collatz sequence is defined as: ai+1={ai23ai+1if ai is evenif ai is odd.
#
...
#cleary too hard, but gonna try to get started.
#first, have to find the five 5prefix families.

#function that founds 5-loops
